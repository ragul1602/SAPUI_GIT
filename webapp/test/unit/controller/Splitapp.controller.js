...
sap.ui.define([
	"COM/SMAX/SPLITAPP/ZPROJECT_ROUTER_SPLITAPP/controller/Splitapp.controller"
	...
	QUnit.test("I should test the app controller loads", function (assert) {
		...
		assert.ok(sName, "COM/SMAX/SPLITAPP/ZPROJECT_ROUTER_SPLITAPP.controller.Splitapp");
	});
