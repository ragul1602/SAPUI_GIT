...
sap.ui.define([
	"COM/SAMX/TABLES/ZPROJECT_ODATA_2TABLES/controller/TABLES_PARALEL.controller"
	...
	QUnit.module("TABLES_PARALEL Controller");

	QUnit.test("I should test the app controller loads", function (assert) {
		var oAppController = new oController();
		var sName = oAppController.getMetadata().getName();
		assert.ok(sName, "COM/SAMX/TABLES/ZPROJECT_ODATA_2TABLES.controller.TABLES_PARALEL");
	});
