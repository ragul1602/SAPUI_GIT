sap.ui.define([
	...
	return Controller.extend("COM.SMAX.SPLITAPP.ZPROJECT_ROUTER_SPLITAPP_MSA.controller.FIRST_CUST", {
		...
		onItemPress: function (oEvent) {
			...
			onPrd: function (oEvent) {
			//oEvent - press
			debugger;
			// var custId = oEvent.getSource().getTitle();
			
			// sap.ui.getCore().byId("__xmlview0--full").setVisible(false);
			// sap.ui.getCore().byId("full").setVisible(false);
