sap.ui.define([
	...
	return Controller.extend("com.smax.multitab.ZPROJECT_ROUTER_MULTITAB.controller.PRDSUP_DET", {
		...
		debugger;
			...
			oRouter.getRoute("PRDSUP_DET").attachPatternMatched(function(oEvent){
				...
				var arg1 = oEvent.getParameter("arguments").X;
	...
	onThird: function(){
		debugger;
		this.getOwnerComponent().getRouter().navTo('THIRD_PAGE');
